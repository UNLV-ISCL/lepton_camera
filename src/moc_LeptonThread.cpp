...
static const char qt_meta_stringdata_LeptonThread[] = {
    ...
    "updateLeftImage(QImage)\0"
    "updateCenterImage(QImage)\0"
    "updateRightImage(QImage)\0performFFC()\0"
    "toggleAGC()\0"
};
...
void LeptonThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateLeftImage((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 2: _t->updateCenterImage((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 3: _t->updateRightImage((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 4: _t->performFFC(); break;
        case 5: _t->toggleAGC(); break;
        default: ;
        }
    }
}
...
// SIGNAL 1
void LeptonThread::updateLeftImage(QImage _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void LeptonThread::updateCenterImage(QImage _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void LeptonThread::updateRightImage(QImage _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
